...
imageLocation = {baseUrl: 'https://res.cloudinary.com/dyubvu51u/image/upload/', cloudName: 'v1562311989'};
    ...
    sliders.map((slider, i) => {
        ...
        imgExtentions.map((extention) => {
            ...
            desktopResolutions.map((resolution, k) => {
                sourceDesktop.srcset += `${imageLocation.baseUrl}c_fill,q_80,w_${resolution},h_800/${imageLocation.cloudName}/Garage%20Sukkel/${slider.name}.${extention} ${resolution}w`;
            ...
            mobileResolutions.map((resolution, k) => {
                sourceMobile.srcset += `${imageLocation.baseUrl}c_fill,q_80,w_${resolution.width},h_${resolution.height}/${imageLocation.cloudName}/Garage%20Sukkel/${slider.name}.${extention} ${resolution.width}w`;
        ...
        jpgFallback.src = `${imageLocation.baseUrl}'c_fill,w_1080/${imageLocation.cloudName}/Garage%20Sukkel/${slider.name}.jpg`;
